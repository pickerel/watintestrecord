...
{
    public class RubyWatiR : RubyBase
    {
        public RubyWatiR(CodeTemplate template) : base(template) { }
        ...
        {
            string code = ClassCreateToString("Page" + windowName, windowName, "Watir::Browser");
            return code;
        }
    }
}
